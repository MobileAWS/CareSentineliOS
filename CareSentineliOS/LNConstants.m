...
+(void)initConstants{
   ON_ENABLED_SENSORS = @[BED_SENSOR_PROPERTY_NAME,CHAIR_SENSOR_PROPERTY_NAME,TOILET_SENSOR_PROPERTY_NAME,INCONTINENCE_SENSOR_PROPERTY_NAME,CALL_SENSOR_PROPERTY_NAME,PORTAL_SENSOR_PROPERTY_NAME];    
